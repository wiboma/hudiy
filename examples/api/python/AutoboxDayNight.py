...
class EventHandler(ClientEventHandler):
    ...
    def toggle_day_night(self, client):
        ...
        set_day_night_mode = hudiy_api.SetAutoboxDayNightMode()
        set_day_night_mode.mode = hudiy_api.SetAutoboxDayNightMode.NIGHT if self._is_night else hudiy_api.SetAutoboxDayNightMode.DAY
        client.send(hudiy_api.MESSAGE_SET_AUTOBOX_DAY_NIGHT_MODE, 0,
