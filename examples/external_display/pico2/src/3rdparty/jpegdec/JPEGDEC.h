...
#define __JPEGDEC__
    ...
    || defined(_WIN64) || defined(PICO_BUILD)
#include <stdint.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
#if defined(HAL_ESP32_HAL_H_) || defined(TEENSYDUINO) || defined(ARM_MATH_CM4) \
    || defined(ARM_MATH_CM7) || defined(__x86_64__) || defined(TEENSYDUINO)
...
#define MAX_BUFFERED_PIXELS 30720
#define MCU_SKIP -8
